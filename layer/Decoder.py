...
class Decoder(tf.keras.Model):
    def __init__(self, hidden_size, feature_dims, model_type):
        ...
        self.dense1 = tf.keras.layers.Dense(units=5*feature_dims, activation=tf.nn.relu)
        self.dense2 = tf.keras.layers.Dense(units=3*feature_dims, activation=tf.nn.relu)
...
class Decoder2(tf.keras.Model):
    ...
    def __init__(self, hidden_size, feature_dims, model_type):
        ...
        self.dense1 = tf.keras.layers.Dense(units=feature_dims, activation=tf.nn.relu, dropout = 0.1)
        self.dense2 = tf.keras.layers.Dense(units=feature_dims, activation=tf.nn.relu, dropout = 0.1)
        self.dense3 = tf.keras.layers.Dense(units=feature_dims, activation=tf.nn.relu, dropout = 0.1)
